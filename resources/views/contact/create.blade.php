            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 flex justify-center">
                    <div class="w-full">
                        ...
                        <form class="max-w-full" action="{{ route('contact.store') }}" method="POST">
                            @csrf
                          <div class="mb-4">
                          ...
                          <div class="mb-4">
                            ...
                            <input type="email" name="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                          </div>
